...
var person
peoplesAges = []
people = peoplesAges.map do |person|
puts peoplesAges.push(person.age)
...
people = peopleYoungerThan35.filter(function (person) {
  if(person.age < 35){
    return peopleYoungerThan35.push(person)
}
});
